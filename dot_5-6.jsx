...
var triangleGroup4 = triangleLeft.groupItems.add();
var triangleGroup5 = triangleLeft.groupItems.add();
...
ellipses2 = triangleGroup1.pathItems.ellipse(0, 0, 0.177*mm, 0.177*mm, false, false );
...
triangleGroup2.top = LeftCY+0.78;
triangleGroup2.left = LobjX+2.41;

triangleGroup3=triangleGroup1.duplicate();
triangleGroup3.top = RobjY + 3.969;
triangleGroup3.left = LobjX+2.41;

triangleGroup4=triangleGroup1.duplicate();
triangleGroup4.top = LeftCY+LeftC1Y+0.78;
triangleGroup4.left = LobjX+2.41;

triangleGroup5=triangleGroup1.duplicate();
triangleGroup5.top = LeftCY-LeftC1Y+0.78;
triangleGroup5.left = LobjX+2.41;

triangleRight = triangleLeft.duplicate();
triangleRight.left = RobjX-3.969;
