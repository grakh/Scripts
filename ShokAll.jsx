...
Oporka.setEntirePath( Array( Array(0, 0), Array(0, hi), Array(5*mms, hi), Array(5*mms, 0) ) );
Oporka.closed = true;
Oporka.filled = true;
...
ellipseskW = Tel1.pathItems.ellipse(xh2+.8, ywk-.8, 6+1.6, 6+1.6, false, false );
ellipseskW.stroked = false;
ellipseskW.filled = true;
ellipseskW.fillColor = PWhite;
ellipseskW.fillOverprint = false;
...
switch (Ops){
	...
	default: ellipsesk.strokeColor =PBlack;
	}
...
Rapp:   Group { orientation: 'row', \
            ...
            text1: StaticText {text:' ,           Длина выборки: '},\
...
dlg.Rapp.texte.text =(Math.round(hi/2.83465)).toString();
//for(i=0; i<sI.length; i++) {
