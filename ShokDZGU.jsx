...
Oporka = newLayer.pathItems.rectangle( 0, 0, 5*mms, hi);
...
ellipseR = rou1.pathItems.ellipse(xh2-2.09+0.1*mms, s-4.73, 10.03, 10.03, false, false );
ellipseR.fillColor = PWhite;
ellipseR.stroked = true;
ellipseR.filled = true;
ellipseR.fillOverprint = false;	
ellipseR.strokeWidth = 0.2*mm;
ellipseR.strokeColor = PWhite;
ellipseR.strokeOverprint = false;

for (k=0; k<18; k++){

rect3 = rou1.pathItems.add();
rect3.setEntirePath( Array( Array(s, xh2+0.1*mms), Array(s+0.22*mms, xh2+0.1*mms), Array(s, xh2-4.9*mms), Array(s+0.22*mms, xh2-4.9*mms) ) );
rect3.rotate(10*k);
...
ellipseR.strokeWidth = 0.2*mm;
ellipseR.strokeColor = PWhite;
ellipseR.strokeOverprint = true;

for (k=0; k<18; k++){

rect4 = rou1.pathItems.add();
rect4.setEntirePath( Array( Array(s, xh2+0.1*mms), Array(s+0.2*mms, xh2+0.1*mms), Array(s, xh2-4.9*mms), Array(s+0.2*mms, xh2-4.9*mms) ) );
rect4.rotate(10*k);
...
textNamb.rotate(90);
textNamb.left = 15;
textNamb.textRange.characterAttributes.fillColor =PWhite;
textNamb.top = T1.height-20*mms;
...
textRapp .rotate(90);
textRapp .left = 15;
textRapp .textRange.characterAttributes.fillColor =PWhite;
...
newCrest = triangleGroup1.pathItems.add();
newCrest.setEntirePath( Array( Array(-1.25*mm, -2*mm), Array(-1.25*mm, 2*mm),  Array(1.25*mm, 2*mm), Array(1.25*mm, -2*mm)) );
newCrest.closed = true;
newCrest.filled = true;
newCrest.stroked = true;
newCrest.strokeWidth = 0.1*mm;
newCrest.strokeColor = app.activeDocument.swatches[Registr].color;
newCrest.strokeOverprint = true;
newCrest.fillColor = PWhite;
newCrest.fillOverprint = false;

ellipsesW = triangleGroup1.pathItems.add();
ellipsesW = triangleGroup1.pathItems.ellipse(0.71*mm, -0.71*mm, 1.42*mm, 1.42*mm, false, false );
ellipsesW.stroked = false;
ellipsesW.filled = true;
ellipsesW.fillColor = PWhite;
ellipsesW.stroked = true;
ellipsesW.strokeWidth = 0.1*mm;
ellipsesW.strokeColor = app.activeDocument.swatches[Registr].color;
ellipsesW.strokeOverprint = true;
...
newCrest1.setEntirePath( Array( Array(-0.075*mm, -2*mm), Array(-0.07*mm, -0.25*mm),  Array(0.07*mm, -0.25*mm), Array(0.075*mm, -2*mm)) );
...
newCrest1 = newCrestPath1.pathItems.add();
newCrest1.setEntirePath( Array( Array(-0.075*mm, 0.3*mm), Array(-0.075*mm, 2*mm),  Array(0.075*mm, 2*mm), Array(0.075*mm, 0.3*mm)) );
newCrest1.closed = true;
newCrest1.filled = true;
newCrest1.stroked = false;
newCrest1.fillColor = app.activeDocument.swatches[Registr].color;
...
newCrest2.setEntirePath( Array( Array(-1.25*mm, -0.075*mm), Array(-0.3*mm,-0.075*mm), Array(-0.3*mm, 0.075*mm), Array(-1.25*mm, 0.075*mm)) );
...
newCrest2 = newCrestPath1.pathItems.add();
newCrest2.setEntirePath( Array( Array(0.3*mm, -0.075*mm), Array(1.25*mm,-0.075*mm), Array(1.25*mm, 0.075*mm), Array(0.3*mm, 0.075*mm)) );
newCrest2.closed = true;
newCrest2.filled = true;
newCrest2.stroked = false;
newCrest2.fillColor = app.activeDocument.swatches[Registr].color;
...
ellipsesc = triangleGroup1.pathItems.ellipse(0.085*mm, -0.085*mm, 0.17*mm, 0.17*mm, false, false );
...
triangleGroup1.top = 9*mm;
triangleGroup1.left = -6.75*mm;

triangleGroup2 = triangleGroup1.duplicate();
triangleGroup2.top = hi/2+2*mm;
triangleGroup2.left = -6.75*mm;

triangleGroup3 = triangleGroup1.duplicate();
triangleGroup3.top = hi-5*mm;
triangleGroup3.left = -6.75*mm;
...
rq1: Group { orientation: 'column', alignChildren: 'left', \
		text: StaticText {text:'White color:'},\
		combo1: ListBox {preferredSize: [380,70], properties:{multiselect:false, focus: true}}, \
		 } \
text: StaticText {text:'', preferredSize:[60,0]},\
