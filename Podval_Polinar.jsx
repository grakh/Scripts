...
Os = $.os;
//alert(''+Os);
if (Os[0] == 'M') ListOfFiles = File ('/Applications/Adobe Illustrator CS5.1/Presets.localized/en_GB/Scripts/Podval_Polinar.ai'); else ListOfFiles = File ('c:\\Podval_Polinar.ai');
